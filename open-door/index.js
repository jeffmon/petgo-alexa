...
const arduinoEndpoint = "http://bcda0588.ngrok.io/open";
...
var SKILL_NAME = "open door";
var GET_FACT_MESSAGE = "Go outside: ";
  ...
  'openDoor': function() {
    rp(arduinoEndpoint)
      .then(htmlString => {
        ...
        this.emit(':tellWithCard', 'Opening door', SKILL_NAME, 'Opening door')
      })
      .catch(err => {
